...
package de.woodcoin.wallet.integration.android;
...
public final class BitcoinIntegration {
    ...
    /**
     * Request any amount of Woodcoins (probably a donation) from user, without feedback from the app.
     *
     * @param context
     *            Android context
     * @param address
    ...
    /**
     * Request specific amount of Woodcoins from user, without feedback from the app.
     *
     * @param context
     *            Android context
     * @param address
    ...
    /**
     * Request any amount of Woodcoins (probably a donation) from user, with feedback from the app. Result
     ...
     *
     * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Woodcoin
    ...
    /**
     * Request specific amount of Woodcoins from user, with feedback from the app. Result intent can be
    ...
    /**
     * Put BIP70 payment message into result intent. Meant for usage by Woodcoin wallet applications.
     *
     * @param result
     *            result intent
     * @param payment
    ...
    /**
     * Get BIP70 payment message from result intent. Meant for usage by applications initiating a Woodcoin
     * payment.
     *
     * You can use the transactions contained in the payment to validate the payment. For this, you need your
     * own Woodcoin infrastructure though. There is no guarantee that the payment will ever confirm.
     *
     * @param result
     *            result intent
    ...
    /**
     * Put transaction hash into result intent. Meant for usage by Woodcoin wallet applications.
     *
     * @param result
     *            result intent
     * @param txHash
    ...
    /**
     * Get transaction hash from result intent. Meant for usage by applications initiating a Woodcoin payment.
     *
     * You can use this hash to request the transaction from the Woodcoin network, in order to validate. For
     * this, you need your own Woodcoin infrastructure though. There is no guarantee that the transaction has
     * ever been broadcasted to the Woodcoin network.
     *
     * @param result
     *            result intent
