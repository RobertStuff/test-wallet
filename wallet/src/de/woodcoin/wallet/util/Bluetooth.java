...
public class Bluetooth {
    ...
    public static final String BIP70_PAYMENT_PROTOCOL_NAME = "Woodcoin BIP70 payment protocol";
    ...
    public static final String CLASSIC_PAYMENT_PROTOCOL_NAME = "Woodcoin classic payment protocol (deprecated)";
